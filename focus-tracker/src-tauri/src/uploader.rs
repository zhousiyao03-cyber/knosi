...
mod tests {
    ...
    fn serializes_sessions_using_camel_case_api_fields() {
        let sessions = vec![QueuedSession {
            ...
            browser_host: Some("gobyexample.com".into()),
            browser_path: Some("/goroutines".into()),
            browser_search_query: None,
            browser_surface_type: Some("docs".into()),
        ...
        assert_eq!(
            ...
            json!({
                ...
                "sessions": [{
                    ...
                    "browserHost": "gobyexample.com",
                    "browserPath": "/goroutines",
                    "browserSearchQuery": null,
                    "browserSurfaceType": "docs",
